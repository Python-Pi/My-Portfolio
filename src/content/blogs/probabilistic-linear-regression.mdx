...
```
where $\delta$ is the regularization paramater 
```math
...
Guassian Likelihood + Guassian Prior = Guassian Posterior. So, the posterior distribution of the weights is also Gaussian:
