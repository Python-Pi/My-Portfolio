...
This is slightly modified version of range sum problem where we need to find the count of subarrays whose sum equals to `K`.
...
This problems is a modifed version of "Subarray sum equals K" problem where we need to find the length of 
